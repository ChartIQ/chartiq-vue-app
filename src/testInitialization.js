...
function handleQueryString() {
	...
	if (useStudyMenu && CIQ.Studies.Favorites) {
		CIQ.Studies.FavoritesDisabled = CIQ.Studies.Favorites
		delete CIQ.Studies.Favorites
	} else if (!useStudyMenu && CIQ.Studies.FavoritesDisabled) {
		CIQ.Studies.Favorites = CIQ.Studies.FavoritesDisabled
	}
